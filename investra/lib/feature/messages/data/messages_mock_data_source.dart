  ...
  static const List<ChatThreadItem> _mirnaThread = [
    ...
    ChatMessageItem(
      ChatMessage(
        id: 'm1',
        text:
            'Here is the updated forecast—let me know if the assumptions look right on your side.',
        isFromUser: false,
        timeLabel: '4:12 PM',
        isRead: true,
      ),
    ...
    ChatMessageItem(
      ChatMessage(
        id: 'm2',
        text:
            'Thanks, Mirna. I will align with the team and send a revised slide by evening.',
        isFromUser: true,
        timeLabel: '4:15 PM',
        isRead: true,
      ),
    ...
    ChatMessageItem(
      ChatMessage(
        id: 'm3',
        text:
            'Noted. Can we add a one-pager on unit economics to the data room?',
        isFromUser: false,
        timeLabel: '9:20 AM',
        isRead: true,
      ),
