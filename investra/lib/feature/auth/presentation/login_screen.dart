...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _navigateBasedOnRole(String role) {
    ...
    if (role == 'Investor') {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('خطأ في تحديد نوع الحساب، يرجى تسجيل الدخول مرة أخرى مؤقتاً'),
                  ...
                  const Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("OR CONTINUE WITH", style: TextStyle(color: Colors.grey, fontSize: 11, fontWeight: FontWeight.bold)),
                      ),
                      Expanded(child: Divider()),
                    ],
                  ),
    ...
    return TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: onToggleVisibility != null
              ? IconButton(icon: Icon(isPass ? Icons.visibility_off_outlined : Icons.visibility_outlined, color: Colors.grey), onPressed: onToggleVisibility)
              : null,
        ));
  }
}
